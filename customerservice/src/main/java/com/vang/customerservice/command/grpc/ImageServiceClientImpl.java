package com.vang.customerservice.command.grpc;

import com.google.protobuf.ByteString;
import com.vang.customerservice.grpc.gen.*;
...
public class ImageServiceClientImpl {
    ...
    public String sendRequestUploadImage(ByteString image, String fileName) {
        UploadReply uploadReply = uploadImageBlockingStub.upload(UploadRequest.newBuilder().setImage(image).setType(NumberUtils.TWO).setImageName(fileName).build());
